...
class VisitorDeleted extends StatefulWidget {
  @override
  _VisitorDeletedState createState() => _VisitorDeletedState();
}

class _VisitorDeletedState extends State<VisitorDeleted> {
  @override
